...
export default function WarmHomeDiscountForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid && formData.termsAccepted) {
      ...
      router.push('/eligibility_results/warm_home_discount_scheme_result');
            ...
            <div className="lg:col-span-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-between items-center pt-6">
                  <button
                    type="button"
                    onClick={() => router.push('/mandatory_form/ppa-assessment-form')}
