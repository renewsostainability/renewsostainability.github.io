...
export default function AMWRenewablePPAForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (isValid && formData.termsAccepted) {
      ...
      router.push('/eligibility_checks/beas_grants_eligibility_form');
    } else {
      ...
      <>
        ...
        <div className="min-h-screen bg-white py-8 mt-16 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600">Loading your PPA application...</p>
          </div>
        </div>
        <Footer />
      </>
