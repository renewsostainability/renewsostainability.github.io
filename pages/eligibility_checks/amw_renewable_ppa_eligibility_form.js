...
export default function AMWRenewableEnergyForm() {
  ...
  const handleSubmit = (e) => {
    ...
    router.push('/eligibility_results/amw_renewable_energy_eligibility_result');
  };
            ...
            <div className="lg:col-span-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex justify-between items-center pt-6">
                  <button
                    type="button"
                    onClick={() => router.push('/mandatory_form/amw-renewable-ppa-form')}
