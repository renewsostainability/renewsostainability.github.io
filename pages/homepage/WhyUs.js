  ...
  const features = [
    {
        ...
        description: 'Demonstrate your commitment to sustainability and environmental responsibility.'
    },
    {
        icon: 'fa-pound-sign',
        title: 'Cost Reduction',
        description: 'Significantly lower your energy bills while improving operational efficiency.'
    },
    {
        icon: 'fa-award',
        title: 'Expert Guidance',
        description: 'Benefit from our extensive experience in energy efficiency and sustainability.'
    },
    {
        icon: 'fa-bolt',
        title: 'Smart Energy Solutions',
        description: 'Leverage intelligent systems to optimize energy usage and monitor performance in real time.'
    }
  ]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div className="text-center lg:text-left lg:pr-8">
          ...
          <h2 className="text-4xl font-bold mb-6 leading-tight">
            The <span className="bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">SOStainability</span> Advantage
          </h2>
          
          <p className="text-lg text-gray-600 leading-relaxed mb-10">
            RENEW is a platform by SOStainability to help entities demonstrate environmental 
            stewardship and embrace sustainability, aligning with the intrinsic NHS core values 
            of nature, humanity, and society.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              ...
              >
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-4">{feature.title}</h4>
